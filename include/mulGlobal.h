...
/*
 * Modifications by: Coenrad Fourie (coenrad@sun.ac.za)
 * 		Mark Volkmann (15164187@sun.ac.za)
 * 		Kyle Jackman (16192044@sun.ac.za)
 * ** This is the fasthenry-3.0wr-8/7/2014 distribution released by
 * Stephen R. Whiteley, with superconductor support. The following
 * changes have been made.
 *
 * 1) Current densities for each node are output too.
 *
 * 2) Passing -V to the executable prints version information to
 *    'ver.txt' in the working directory.
 *
 * 3) Compilation for 32-bit and 64-bit Windows has been enabled.
 *    For further compilation instructions please see 'ICOMPILE'
 */
/* Enable SU 09/14/2014 changes */
#define SU0914
...
#ifndef OTHER
//#include <unistd.h> BAP comment out
#endif // OTHER
...
int ACA(int, int, charge**, charge**);//BAP ADD
